 ...
 *
 * The values are copied verbatim (jupiter.mjs:23 and :53) and pinned by
 * test-hawk-bundle.mjs, which imports the real module in Node and compares — a drift in
 * either file fails the suite rather than the next swap.
 */
