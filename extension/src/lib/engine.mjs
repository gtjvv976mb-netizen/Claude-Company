 ...
 * `executor/grade-entry-gates.mjs --file <export>` grades this lane's rows exactly as it
...
} from "../../../executor/snipe-venue-pumpfun.mjs";
import { snipeContract, planSnipeCeiling } from "../../../executor/snipe-entry.mjs";
import { curveExitMarkX, frictionXFor, snipeCurveState } from "../../../executor/snipe-curve.mjs";
import * as snipePolicyModule from "../../../executor/snipe-policy.mjs";
import { bindDeterminer, SNIPE_LANE_DEFAULTS } from "../../../executor/snipe-lane.mjs";
import { openSnipe, updateSnipe, closeSnipe, snipeList, snipeFor, ensureSnipeBook } from "../../../executor/snipe-book.mjs";
import { createSnipeShadow, snipeScorecard, shadowReport } from "../../../executor/snipe-shadow.mjs";
import { readSocials } from "../../../executor/snipe-socials.mjs";
import { TOKEN_PROGRAM, TOKEN_2022_PROGRAM } from "../../../executor/token2022.mjs";
import {
...
export function createHawkEngine({
  ...
  async function enterForReal({ mint, pos, curve, verdict, frictionX, read, prepared, wallet, now }) {
    ...
    try {
      ...
      notify({ kind: "buy", mint, title: "HAWK-AI: approve the buy in Phantom", body: summary });
      ...
      try {
        ...
        notify({ kind: "attention", mint, title: "HAWK-AI: a fill the book refused", body: `${short(mint)} was bought (${signature}) but could not be booked. Sell it by hand.` });
  ...
  async function sellForReal({ pos, curve, read, markX, reason, now }) {
    ...
    if (curve.complete === true) {
      if (!pos.graduated) {
        ...
        notify({ kind: "attention", mint, title: "HAWK-AI: sell by hand", body: `${pos.symbol ?? short(mint)} graduated to a pool. The lane cannot sell it; sell it yourself.` });
        await persist();
      }
    ...
    try {
      ...
      notify({ kind: "sell", mint, title: "HAWK-AI: APPROVE THE SELL IN PHANTOM", body: summary });
  ...
  /** The shadow book as JSONL, the file executor/grade-entry-gates.mjs --file reads. */
